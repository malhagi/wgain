  ...
  const handleCorrect = async () => {
    ...
    try {
      ...
      if (currentVocab.example) {
        await speakChinese(currentVocab.example);
      }
      ...
      <div className="mb-6">
        ...
        {currentVocab.example && (
          <div className="mt-5 p-5 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl border border-purple-200/50 shadow-sm">
            <div className="text-sm font-bold text-purple-900 mb-2">📝 Example:</div>
            <div className="text-base text-black font-medium">{currentVocab.example}</div>
          </div>
        )}
